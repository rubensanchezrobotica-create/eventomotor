...
.emc-hero { min-height: 86vh; padding: 118px 0 44px; display: flex; align-items: center; position: relative; z-index: 1; }
.emc-hero-grid { display: grid; grid-template-columns: minmax(0, 1.06fr) minmax(360px, .72fr); gap: 36px; align-items: stretch; }
...
.emc-hero h1 { max-width: 760px; font-size: clamp(44px, 5.5vw, 76px); line-height: .92; letter-spacing: -3.8px; margin-bottom: 18px; }
.emc-hero-copy { max-width: 760px; color: #cbd3df; font-size: 18px; line-height: 1.6; margin-bottom: 0; }
...
.emc-micro-map { flex: 1; min-height: 390px; position: relative; border-radius: 28px; overflow: hidden; border: 1px solid var(--emc-line); background: radial-gradient(circle at 70% 34%,rgba(255,59,0,.28),transparent 18%), radial-gradient(circle at 42% 54%,rgba(75,163,255,.18),transparent 20%), linear-gradient(135deg,#121b2a,#070a11); }
