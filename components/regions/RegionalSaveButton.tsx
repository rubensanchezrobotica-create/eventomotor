...
export default function RegionalSaveButton({
  event,
  source,
}: RegionalSaveButtonProps) {
  const [saved, setSaved] = useState(false);

  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- Refleja el estado persistido en localStorage.
