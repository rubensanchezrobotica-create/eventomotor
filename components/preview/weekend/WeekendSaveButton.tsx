...
type WeekendSaveButtonProps = {
  event: SavedEvent;
};

export default function WeekendSaveButton({ event }: WeekendSaveButtonProps) {
  const [saved, setSaved] = useState(false);

  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- Sincroniza el estado real guardado en localStorage.
