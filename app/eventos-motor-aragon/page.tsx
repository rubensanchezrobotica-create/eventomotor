...
const page = getOpportunityPage("eventos-motor-aragon");

export const metadata: Metadata = buildOpportunityMetadata(page);

export default function EventosMotorAragonPage({
  searchParams,
}: {
  searchParams: Promise<Record<string, string | string[] | undefined>>;
}) {
  if (!page) notFound();
  return <PublicRegionalLanding page={page} region="aragon" searchParams={searchParams} />;
}
