...
const page = getOpportunityPage("eventos-motor-canarias");

export const metadata: Metadata = buildOpportunityMetadata(page);

export default function EventosMotorCanariasPage({
  searchParams,
}: {
  searchParams: Promise<Record<string, string | string[] | undefined>>;
}) {
  if (!page) notFound();
  return <PublicRegionalLanding page={page} region="canarias" searchParams={searchParams} />;
}
