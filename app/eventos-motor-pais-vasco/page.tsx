...
const page = getOpportunityPage("eventos-motor-pais-vasco");

export const metadata: Metadata = buildOpportunityMetadata(page);

export default function EventosMotorPaisVascoPage({
  searchParams,
}: {
  searchParams: Promise<Record<string, string | string[] | undefined>>;
}) {
  if (!page) notFound();
  return <PublicRegionalLanding page={page} region="paisVasco" searchParams={searchParams} />;
}
