...
const HEADER_TEXT = "LA AGENDA MOTOR · EDICIÓN 02 · 14–16 AGOSTO 2026";
const ROOT = process.cwd();
const REFERENCE_LOGO_PATH = resolve(
  ROOT,
  "public/newsletter/2026-08-06/assets/eventomotor-logo.png",
);
const OUTPUT_PATHS = [
  resolve(
    ROOT,
  ...
  resolve(
    ROOT,
    "docs/newsletter/ediciones/2026-08-13/assets/eventomotor-header.png",
  ),
];
