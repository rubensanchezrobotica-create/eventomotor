...
const HEADER_TEXT = "LA AGENDA MOTOR · EDICIÓN 04 · 28–30 AGOSTO 2026";
const ROOT = process.cwd();
const REFERENCE_LOGO_PATH = resolve(
  ROOT,
  "public/newsletter/2026-08-27/assets/eventomotor-logo.png",
);
const OUTPUT_PATHS = [
  resolve(
    ROOT,
    "public/newsletter/2026-08-27/assets/eventomotor-header.png",
  ),
  resolve(
    ROOT,
    "docs/newsletter/ediciones/2026-08-27/assets/eventomotor-header.png",
  ),
];
